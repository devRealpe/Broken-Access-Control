...
// Endpoint: GET /backend/api/doctor_patients.php
...
requireRole('doctor');  // ← Este sí verifica rol correctamente

$user = currentUser();
$db   = getDB();

// Obtener el ID del doctor
$stmt = $db->prepare("SELECT id, specialty, license_number FROM doctors WHERE user_id = ?");
